    ...
    <div class="border-b py-3 text-sm">
        <div>
            ...
            <div class="flex gap-3 items-center mt-1">
                <div class="w-8 h-8 overflow-hidden rounded-full lg:w-10 lg:h-10">
                    <NuxtImg :src="'https://ui-avatars.com/api/?name=' + review.user_name.replaceAll(' ', ' + ')" :alt="review.user_name" />
                </div>
                <p class="font-medium">
                    {{ review.user_name }}
                </p>
        ...
        <div v-if="showReply" class="bg-slate-100 p-1.5 rounded-lg m-1 mt-4 lg:p-3 lg:m-2">
            <div v-if="reply">
                <div class="flex gap-3 items-center mt-1">
                    <div class="w-8 h-8 overflow-hidden rounded-full lg:w-10 lg:h-10">
                        <NuxtImg :src="'https://ui-avatars.com/api/?name=' + 'Ko Aliong'.replaceAll(' ', ' + ')" alt="seller" />
                    </div>
