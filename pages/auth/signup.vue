...
<template>
  <section
    class="flex flex-col justify-center items-center h-screen font-rubik px-4 md:px-0"
  >
    <form class="w-full md:max-w-sm" @submit.prevent="onSubmitHandler">
      ...
      <Button class="w-full mt-5">Sign Up</Button>
    </form>
    <div class="w-full md:max-w-sm mt-5">
      <Button
        class="bg-white text-black w-full flex gap-2 p-6 border hover:bg-white hover:text-black shadow-md"
